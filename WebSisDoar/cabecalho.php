                ...
                <div class="sidebar-inner slimscroller">
					...
					<div id="sidebar-menu">
						<ul>
							...
							<li class="active"><a href="#fakelink"><i class="fa fa-envelope"></i><i class="fa fa-angle-double-down i-right"></i> Message  <span class="label label-success new-circle span-left">UPDATED</span></a>
								<ul class="visible">
									<li class="active"><a href="inbox.html"><i class="fa fa-angle-right"></i> Inbox</a></li>
