    ...
    <body class="tooltips">
        ...
        <div class="container">
            ...
            <div class="logo-brand header sidebar rows">
                <div class="logo">
                    <h1><a href="#fakelink"><img src="assets/img/apple-touch-icon.png" alt="Logo"> WEB SISDOAR</a></h1>
                </div>
                    ...
                    <div class="sidebar-inner slimscroller">
                        ...
                        <div class="media">
                            <a class="pull-left" href="#fakelink">
                                <img class="media-object img-circle" src="assets/img/Ingryd_perfil.jpg" alt="Avatar">
                            </a>
                            <div class="media-body">
                                Bem Vindo,
                                <h4 class="media-heading"><strong>Ingryd Silva</strong></h4>
                                <a href="user-profile.html">Editar</a>
                                <a class="md-trigger" data-modal="logout-modal-alt">Sair</a>
