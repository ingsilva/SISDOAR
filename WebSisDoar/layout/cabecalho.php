    ...
    <body class="tooltips">
        ...
        <div class="container">
            ...
            <div class="logo-brand header sidebar rows">
                <div class="logo">
                    <h1><a href="/SISDOAR/WebSisDoar/DashBoard.php"><img src="/SISDOAR/WebSisDoar/assets/img/apple-touch-icon.png" alt="Logo"> WEB SISDOAR</a></h1>
                </div>
                    ...
                    <div class="sidebar-inner slimscroller">
                        ...
                        <div id="sidebar-menu">
                            <ul>
                                ...
                                <li><a href="#fakelink"><i class="fa fa-table"></i><i class="fa fa-angle-double-down i-right"></i> Localização</a>
                                    <ul>
