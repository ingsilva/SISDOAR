    ...
    <body>
        <div class="body content rows scroll-y">
            ...
            <div class="page-heading animated fadeInDownBig">
                <h1><small> Cadastro de </small> Paciente </h1>
            </div>
            <!-- End page header -->
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="box-info">
                        ...
                        <div id="basic-form" class="collapse in">
                            <form role="form" action="../../funcoes/paciente/function_paciente.php" method="post">
                                <div class="row">
                                ...
                                <!--================================================-------> 
                                <button type="submit" name="paciente" class="btn btn-success">Enviar</button>
