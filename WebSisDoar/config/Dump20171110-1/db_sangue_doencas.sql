...
CREATE TABLE `doencas` (
  `iddoencas` int(11) unsigned NOT NULL,
...
INSERT INTO `doencas` VALUES (1,'Anti- HBC'),(2,'HBS-Ag'),(3,'HCV'),(4,'HIV'),(5,'HTLV'),(6,'Chagas'),(7,'Sífilis'),(8,'Malária');
...
-- Dump completed on 2017-11-10 17:01:51
