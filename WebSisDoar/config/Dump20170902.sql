...
INSERT INTO `doador` VALUES (2,'Ingryd Silva','1998-07-25','045.506.345-00','23944334','estrada do calafate',231,'nova esperanÃÂ§a','do lado da distribuidora',1,'O','Negativo',20,'f',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'JULIANY DOS SANTOS QUINTAO','07/09/1996','035.456.354-45','45654589','avenida ceará, 2351',142,'','teste',1,'B','Negativo',20,'Masculino','25/05/2017',12345,'SSP/AC','Branco','Fulano','Fulana','Casado','Não Alfabetizado','rio branco'),(7,'Laís Vasconcelos','1993-05-23','018.663.372-62','601018','Rua America',142,NULL,NULL,2,'A','positivo',24,'f',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,'Jacinta Oliveira','1996-05-06','999.111.234-45','11111112-0','Rua Tião',235,'Centro','Casa',2,'AB','positivo',21,'f',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `estoque` VALUES (1,5,'A','Negativo'),(2,5,'A','Positivo'),(3,0,'B','Negativo'),(4,0,'B','Positivo'),(5,0,'O','Negativo'),(6,0,'O','Positivo');
...
INSERT INTO `triagem` VALUES (3,20,75,'nao',2,'sim'),(4,21,1,'sim',9,'nao'),(5,24,54,'nao',7,'sim'),(6,24,55,'nao',7,'sim');
...
-- Dump completed on 2017-09-02 19:59:43
