...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Tabela Agenda para adição de numeros dos funcionarios ou departamentos';
...
INSERT INTO `agenda` VALUES (1,'Jão Souza de Oliveira',996026654,68),(2,'Ricardo Santana Pinto',999668907,68),(3,'Juliana Sales de Melo',981778900,97);
...
CREATE TABLE `doador` (
  ...
  `numero_sus` varchar(45) NOT NULL,
  ...
  `expeditor` varchar(8) NOT NULL,
  `estado_civil` varchar(2) NOT NULL,
  `escolaridade` varchar(2) DEFAULT NULL,
  ...
  PRIMARY KEY (`iddoador`,`data_nascimento`),
...
INSERT INTO `doador` VALUES (2,'','','Ingryd Silva','','','1998-07-25',20,'f',NULL,'','','23944334','','',NULL,'estrada do calafate',231,'nova esperanÃÂ§a','do lado da distribuidora',1,'O','Negativo'),(5,'','','Joao da Silva ','','','1996-09-07',20,'m',NULL,'','','45654589','','',NULL,'estrada do calafate',554,'chico mendes','do lado da distribuidora',1,'AB','Positivo'),(7,'','','Laís Vasconcelos','','','1993-02-28',24,'f',NULL,'','','601018','','',NULL,'Rua America',0,'Nova Estação','',1,'A','positivo'),(8,'','','José Oliveira Costa','','','1994-06-29',23,'m',NULL,'','','67769002-1','','',NULL,'Rua Oca',22,'Centro','Ao lado da Studio Z',1,'A','negativo'),(9,'','','Jacinta Oliveira','','','1996-05-06',21,'f',NULL,'','','11111112-0','','',NULL,'Rua Tião',235,'Centro','Casa',5,'AB','positivo'),(13,'','','junior castro','','','1996-02-06',22,'m',NULL,'','','11659599','','',NULL,'estrada do calafate',142,'nova esperança','avenida',2,'A','positivo');
...
-- Dump completed on 2017-06-03  2:40:46
