...
CREATE TABLE `questionario_triagem` (
  ...
  `quando_doou` varchar(5) DEFAULT NULL,
  `quantas_vzs_doou` varchar(11) DEFAULT NULL,
...
INSERT INTO `questionario_triagem` VALUES (16,7,'nao','nao','nao','nao','nao','nao','nao','nao','sim','2015','1','HEMOCENTRO','NÃO','NÃO','nao_apto','O Doador não está apto a Doar, devido ter ingerido bebida alcoolica dentro de 24h.'),(17,8,'sim','nao','nao','sim','sim','nao','nao','nao','nao','2015','2','HEMOACRE','Não','Não','apto','O Doador está apto para efetuar a coleta'),(26,12,'sim','sim','sim','sim','sim','sim','sim','sim','sim','2015','2','hemoacre','não','não','apto','mentiroso'),(27,13,'sim','nao','nao','nao','nao','nao','nao','nao','nao','2017','1','hemocentro','nao','nao','apto','teste'),(28,13,'sim','nao','nao','sim','sim','sim','sim','sim','sim','2015','','','','','apto',''),(29,13,'nao','sim','sim','sim','sim','nao','sim','sim','sim','','','','','','apto','');
...
-- Dump completed on 2017-11-13  9:55:20
