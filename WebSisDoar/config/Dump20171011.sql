...
INSERT INTO `agenda` VALUES (1,'Jão Souza de Oliveira',996026654,68,1),(3,'Juliana Sales de Melo',981778900,97,2),(5,'Lais Vasconcelos',999151285,69,1),(11,'Saionara Cardoso',984184786,68,2),(12,'jailson bernarrdo',992838635,68,6);
...
CREATE TABLE `agendamento` (
  ...
  `agend_hora` time DEFAULT NULL,
  `agend_data` date DEFAULT NULL,
...
INSERT INTO `agendamento` VALUES (5,'10:00:00','2017-09-20',69),(6,'13:00:00','2017-09-28',75),(7,'13:00:00','2017-09-28',76),(8,'08:00:00','2017-10-11',77);
...
CREATE TABLE `cidade` (
  ...
  CONSTRAINT `fk_cidade_estado1` FOREIGN KEY (`estado_idestado`) REFERENCES `banco2`.`estado` (`idestado`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `estoque` (
  ...
  `fator_rh` varchar(45) NOT NULL,
  PRIMARY KEY (`idestoque`,`tipo`,`fator_rh`)
...
INSERT INTO `estoque` VALUES (1,5,'A','Negativo'),(2,7,'A','Positivo'),(3,0,'B','Negativo'),(4,0,'B','Positivo'),(5,0,'O','Negativo'),(6,0,'O','Positivo');
...
INSERT INTO `triagem` VALUES (4,21,1,'sim',9,'nao'),(5,24,54,'nao',7,'sim'),(6,24,55,'nao',7,'sim');
...
-- Dump completed on 2017-10-11 22:20:26
