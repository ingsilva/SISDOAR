                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <p class="text-muted">O doador pode candidatar-se a doação de três formas:</p>
                            <div class="text-justify">
                                ...
                                <li>Doação autóloga: doar para si mesmo.</li>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <div class="text-justify">
                                <li>Ter idade entre 18 e 69 anos, 11 meses e 29 dias;</li>
                                ...
                                <li> Evitar vir acompanhado com crianças, sem acompanhantes.</li>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <h3>NÃO PODE DOAR</h3>
                            <p class="text-muted">Quem tem ou teve as seguintes doenças:</p>
                            <div class="text-justify">
                            ...
                            <p class="text-muted">Outras situações:</p>
                            <div class="text-justify">
