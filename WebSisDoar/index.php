        ...
        <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
            <div class="container topnav">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand topnav" data-toggle="modal" data-target="#acesso" data-whatever="@mdo">Acesso Sistema</a>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Usuário" id="txUsuario">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control" placeholder="Senha" id="txSenha">
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            <div class="col-md-8 col-sm-offset-2">
                                <a href="DashBoard.php" class="btn btn-md  btn-primary btn-block">Login</a> 
                            </div>
                        </div>
                    </div>
                </div>
